function viaduto = cria_viaduto_aleatorio_relativo(apoios_possiveis, viaduto, terreno, greide, pgm, pgmr)
...
viaduto.longarinas.c =   aleatorio_entre_arredondado(pgm.longarinas.c);
...
for i=1:viaduto.n_apoios-1
    ...
    viaduto.vao(i).longarina.h1 = aleatorio_entre_arredondado_relativo(pgm.longarinas.h1, pgmr.longarinas.h1_em_funcao_vao, viaduto.vao(i).l);
    viaduto.vao(i).longarina.h2 = aleatorio_entre_arredondado_relativo(pgm.longarinas.h2, pgmr.longarinas.h2_em_funcao_h1, viaduto.vao(i).longarina.h1);
    viaduto.vao(i).longarina.h3 = aleatorio_entre_arredondado_relativo(pgm.longarinas.h3, pgmr.longarinas.h3_em_funcao_h1, viaduto.vao(i).longarina.h1);
    viaduto.vao(i).longarina.h4 = aleatorio_entre_arredondado_relativo(pgm.longarinas.h4, pgmr.longarinas.h4_em_funcao_h1, viaduto.vao(i).longarina.h1);
    viaduto.vao(i).longarina.h5 = aleatorio_entre_arredondado_relativo(pgm.longarinas.h5, pgmr.longarinas.h5_em_funcao_h1, viaduto.vao(i).longarina.h1);
    viaduto.vao(i).longarina.b1 = aleatorio_entre_arredondado_relativo(pgm.longarinas.b1, pgmr.longarinas.b1_em_funcao_h1, viaduto.vao(i).longarina.h1);
    viaduto.vao(i).longarina.b2 = aleatorio_entre_arredondado_relativo(pgm.longarinas.b2, pgmr.longarinas.b2_em_funcao_h1, viaduto.vao(i).longarina.h1);
    viaduto.vao(i).longarina.b3 = aleatorio_entre_arredondado_relativo(pgm.longarinas.b3, pgmr.longarinas.b3_em_funcao_h1, viaduto.vao(i).longarina.h1);
    ...
    viaduto.vao(i).longarina.benr = aleatorio_entre_arredondado(pgm.longarinas.benr_alterado);
    ...
    viaduto.vao(i).aap = aleatorio_entre_arredondado_relativo(pgm.longarinas.hpa, pgmr.longarinas.hpa, 1) * viaduto.vao(i).longarina.h1;% altura estimada do cg da protensão na ancoragem
    
    viaduto.vao(i).ntcord = aleatorio_entre_arredondado(pgm.longarinas.ncp); %numero total de cordoalhas por longarina
    
    viaduto.vao(i).laje.h = aleatorio_entre_arredondado_relativo(pgm.lajes.h, pgmr.lajes.h_em_funcao_vao, viaduto.W/(viaduto.vao(i).n_longarinas-1));%m
